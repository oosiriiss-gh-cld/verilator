...
module t;
  ...
  // Distinct specializations of one nested class.  Note two specializations of the
  // same nested class reached through *different* specializations of its parent, as in
  // 'a#(32)::b#(3)' alongside 'a#(16)::b#(3)', still collapse into one: V3Param names
  // clones from the parameter values alone, which is a separate issue from this chain
  // resolution and is not covered here.
  pkg::a #(16)::b #(3)::t          s1;
  pkg::a #(16)::b #(9)::t          s2;
